...
const PcItem: FunctionComponent<PcItemProps> = ({ item, buyPc }) => {
    return (
        <>
                    ...
                    <dl className="-mx-4 -mt-4 flex flex-wrap">
                        ...
                        {item.meta.attributes.map(attribute =>
                            <div key={attribute.trait_type} className="flex flex-col px-4 pt-4">
                                ...
                                <dd className="order-1 text-xl font-extrabold text-blue-600">{attribute.value}</dd>
                            </div>
                        )}
                    </dl>
                </div>
